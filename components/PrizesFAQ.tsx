...
function PrizeMoney() {
  const prizes = [
    { amount: "NPR 1.30 lakh+", label: "Total prize pool" },
...
//       {/* Gadgets Card */}
//       <div
//         className="relative rounded-2xl overflow-hidden p-5 h-36"
//         style={{
//           background:
...
//             Latest tech gear for the champions
//           </p>
//         </div>
...
//         style={{
//           background:
//             "linear-gradient(135deg, #0d1a0d 0%, #142014 50%, #0d1a0d 100%)",
//         }}
//       >
//         <div className="absolute inset-0 border border-green-500/20 rounded-2xl" />
//         <div className="absolute top-0 left-0 w-32 h-32 bg-green-400/8 rounded-full blur-2xl" />
...
//       {/* Certificate Card */}
//       <div
//         className="relative rounded-2xl overflow-hidden p-5 flex-1"
//         style={{
//           background:
//             "linear-gradient(135deg, #0d0d1a 0%, #14142a 50%, #0d0d1a 100%)",
//         }}
//       >
//         <div className="absolute inset-0 border border-blue-500/20 rounded-2xl" />
...
//             Industry-recognized achievements for all finalists
//           </p>
//         </div>
//       </div>
//     </div>
...
//             className="overflow-hidden"
//           >
//             <p className="text-[#A3A3A3] text-sm leading-relaxed pb-4">
//               {answer}
//             </p>
//           </motion.div>
//         )}
